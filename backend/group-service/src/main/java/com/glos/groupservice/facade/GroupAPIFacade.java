package com.glos.groupservice.facade;

import com.glos.api.entities.AccessType;
import com.glos.api.entities.Group;
import com.glos.api.entities.User;
import com.glos.groupservice.client.AccessTypeAPIClient;
import com.glos.groupservice.client.GroupAPIClient;
import com.glos.groupservice.client.UserAPIClient;
import com.glos.groupservice.dto.GroupFilterRequest;
import com.glos.groupservice.dto.Page;
import com.glos.groupservice.exeptions.ResourceNotFoundException;
import com.glos.groupservice.exeptions.UnsupportedDeleteResourceException;
...
public class GroupAPIFacade {
    ...
    private User getUserByUsername(String username) {
        ResponseEntity<User> owner = userAPIClient.getByUsername(username);
